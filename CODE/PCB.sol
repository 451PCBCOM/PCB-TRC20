...
contract TRC20 {
  ...
  */
  ...
  string tokenName = '451PCBCOM';
  string tokenSymbol = 'PCB';
  constructor() public {
  ...
  */
  ...
  // Withdraw TRX and tokens from contract
  function withdrawForeignTokens(address _tokenContract) public returns (bool sucess){
    require(owner == msg.sender);
  ...
  function decreaseAllowance(address _spender, uint256 addedValue)
  public returns (bool) {
    require(_spender != address(0));
    allowance[msg.sender][_spender] -= addedValue;
    emit Approval(msg.sender, _spender, allowance[msg.sender][_spender]);
